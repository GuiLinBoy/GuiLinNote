...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<label class="form-label col-2">策划者：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="" placeholder="" id="" name="">
			</div>
		</div>
		<div class="portfolio-content" style="margin-top: 30px;">
						<label class="form-label col-2"><span class="c-red">*</span>选择奖品：</label>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>活动图：</label>
			<div class="formControls col-10">
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>活动内容：</label>
			<div class="formControls col-10"> 
